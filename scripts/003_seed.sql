...
-- Volume de agendamentos para teste.
--
-- A parte de cima deixa oito agendamentos, o bastante para ver a tela funcionando e pouco para
-- exercitá-la: não enche uma página, não dá o que filtrar e não põe nada no dia de hoje, que é
-- onde a agenda abre. Esta parte preenche três semanas em volta de hoje.
--
-- Clientes e veículos próprios, e os agendamentos só usam esses: os veículos de cima já têm horário
...
dias AS (
    -- Domingo a oficina não abre. Dia que já tem agenda também fica de fora: a parte de cima marca três
